...
import { 
  ...
  TrendingUp, Settings, Search, LayoutGrid
} from 'lucide-react';
...
export const Home: React.FC = () => {
  // LOGIC FIX: Initialize state immediately with a function.
  // This prevents the "Flash" of the wrong page because it calculates
  // the mode BEFORE the first return statement.
...
const AppDashboard: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 pb-20">
      ...
      {/* Added animate-in to make the dashboard appear smoothly after splash */}
...
// ==========================================
// 2. WEB LANDING PAGE (Keep as is, just collapsed for brevity)
// ==========================================
const WebLanding: React.FC = () => {
    // ... [Your existing WebLanding code goes here unchanged] ...
    // Note: I'm not repeating the massive WebLanding code block here to save space,
    // but in your file, keep the WebLanding component exactly as it was in the previous step.
